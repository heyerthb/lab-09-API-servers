...
/**This is a function
 * @param {Object} - Takes user input
 * @param {String} - A response to user input
 * @param {Function} - An an async directive
 * @returns {Object} - Returns an instance of a new Model
 */
...
/**This is a function
 * @returns{Object} - The return value is filtered data.
 */
